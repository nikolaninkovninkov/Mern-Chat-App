...
function register(req, res) {
    return __awaiter(this, void 0, void 0, function () {
        var registerInfo, foundUsersEmail, foundUsersUsername, newUser;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    foundUsersEmail = _a.sent();
                    return [4 /*yield*/, User_1.default.find({
                            username: registerInfo.username,
                        })];
                case 2:
                    foundUsersUsername = _a.sent();
                    ...
                    newUser = new User_1.default(__assign({}, registerInfo));
                    bcryptjs_1.default.genSalt(10, function (err, salt) {
                        ...
                        bcryptjs_1.default.hash(newUser.password, salt, function (err, hash) {
                            ...
                            newUser.save().then(function (user) {
                                tokenJWT_1.default(req, res, user);
                            });
                        });
                    });
                    return [2 /*return*/];
